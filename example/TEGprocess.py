...
TEGprocess.getUnit("TEG regeneration column").getCondenser().setOutTemperature(273.15 + 110.3)
TEGprocess.getUnit("TEG regeneration column").getReboiler().setOutTemperature(273.15 + 205.6)
