...
GasOilProcess.getUnit("well stream cooler/heater").setOutTemperature(323.15)
GasOilProcess.getUnit("well stream cooler/heater").setOutPressure(52.21)
GasOilProcess.getUnit("inlet choke valve").setOutletPressure(51.21)
